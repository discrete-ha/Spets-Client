...
namespace Spets.Airflare.Shared
{
    ...
    public sealed class ReplaceBuildings : MonoBehaviour
    {
        ...
        {
            BuildingSquasher squasher = go.AddComponent<BuildingSquasher>();
            squasher.Target = AvatarController.avatar.transform;

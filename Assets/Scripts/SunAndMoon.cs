...
namespace Spets.Airflare.Shared
{
    ...
    public sealed class SunAndMoon : MonoBehaviour
    {
        ...
        /// </summary>
        private const float HalfLightThickness = 1.45f;
        ...
        public GameObject AvatarSpotLight;
        ...
        {
            //Debug.Log("SunAndMoonController TrySetup()");
            ...
            // the time of day/night. Also extend Camera'ㄴs far clipping plane so that the ground can
            ...
            // Sky.SetFloat("_SunSizeConvergence", 10);
        ...
        internal void setupTime()
        {
            ...
            //var hourUnit;
            double time = System.DateTime.Now.TimeOfDay.TotalHours;
            //double time = 11.00;
            //SpetsLogger.Show("System.DateTime.Now.TimeOfDay.TotalHours:" + System.DateTime.Now.TimeOfDay.TotalHours);
            if (time >= 12 && time < 24)
            {
                time -= 12;
            }
            ...
            time = time * (1.0f / 24.0f);
            //Debug.Log("time unit:" + time);
            //InstructionsHandler.InstructionsText.text += "time unit:" + time + " \n";
            //var = ()1 / 24;
            Set((float)time);
        }
        ...
        {
            Debug.Log("SunAndMoolController StartAnimating()");
        ...
        {
            Debug.Log("SunAndMoolController StartAnimatingAt()");
            // Make sure this script is setup, setting it up now if not.
            TrySetup();
        }
        ...
        private bool VerifyParameters()
        {
            ...
            {
                Debug.LogError("Emission Controller");
            ...
            if (FogStart < 0f)
            {
                Debug.LogError("Fog Start distance ");
            ...
            {
                Debug.LogError("Render Distance");
